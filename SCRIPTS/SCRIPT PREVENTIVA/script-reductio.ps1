...
function LimparLixo {
    ...
    #  Busca se o usuário tem direito administrativo pra rodar o script (só pra garantir)
        ...
        # Configura o tempo de desligamento da tela (Display timeout). Mude à vontade ou exclua. 
        powercfg /change monitor-timeout-ac 30
        powercfg /change monitor-timeout-dc 30

        # Configura o tempo de suspensão do sistema (Sleep timeout). Mude à vontade ou exclua. 
        powercfg /change standby-timeout-ac 240
        powercfg /change standby-timeout-dc 240 
        # Abaixo tem 3 comandos que passam diferentes reparadores do Windows. Não usei o chkdsk pois ele exige confirmação e eu queria minimizar as confirmações no script pra torná-lo menos manual
        sfc /scannow 
...
# Função para configurar o DNS (escolha o DNS de destino substituindo esses 8.8.8.8, 8.8.4.4 etc. Esses são os DNS do Google e do Cloudflare respectivamente.)
